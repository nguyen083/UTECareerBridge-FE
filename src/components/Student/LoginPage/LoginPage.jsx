    ...
    <Row className="full-height-row">
      <Col xs={24} lg={12} className="left-column">
        ...
        >
          ...
          <Card
            title={
              <Title level={3} className="mt-5 text-center card-title ">
                {t("auth.login.title")}
              </Title>
            }
            ...
            <Flex>
              ...
              >
                <Form.Item
                  ...
                  label={
                    <div className="form-label">
                      {t("auth.login.email/phone")}
                    </div>
                  }
                  rules={[
                    {
                      required: true,
                      message: t("auth.login.email/phoneRequired"),
                    },
                    () => ({
                      validator(_, value) {
                        if (!value) {
                          return Promise.reject(
                            t("auth.login.email/phoneRequired")
                          );
                        }
                        if (emailRegex.test(value)) {
                ...
                <Form.Item
                  name="password"
                  label={
                    <div className="form-label">{t("auth.login.password")}</div>
                  }
                  rules={[
                    {
                      required: true,
                ...
                <Form.Item>
                  ...
                  >
                    <FcGoogle size={24} className="me-1" />

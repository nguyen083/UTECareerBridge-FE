...
import { Modal, Typography, Progress, Card, Row, Col, Button, Tag, Tooltip, Space, List, Avatar } from 'antd';
import { CheckCircleOutlined, StarOutlined, StarFilled, EnvironmentOutlined, DollarOutlined, CalendarOutlined, BookOutlined } from '@ant-design/icons';
    ...
    <Modal
      ...
      title={
        <div className="modal-header">
          ...
          />
          <Title level={4} className="modal-title">{t('cvAnalysis.resultTitle')}</Title>
        </div>
      }
    >
                  ...
                  <Card className="job-card" hoverable>
                    <div className="job-card-content">
                      <div className="company-logo">
                        ...
                        />
                        {job.isSaved && (
                          <StarFilled className="saved-icon" />
                        )}
                      </div>
                      ...
                      <div className="job-info">
                        ...
                        <Row gutter={16} className="job-details">
                          ...
                          <Col xs={24} sm={12}>
                            <Space>
                              <BookOutlined />
                              <Text>{job.experienceRequired || t('job.noExperience')}</Text>
                            </Space>
                          </Col>
                        </Row>
                        ...
                        <div className="match-score">
                          <Tooltip title={t('cvAnalysis.matchScoreTooltip')}>
                            <Progress 
                              ...
                              format={percent => `${percent}% ${t('cvAnalysis.match')}`}
                            />
                          </Tooltip>
                        </div>
                        ...
                        <div className="job-actions">
                          ...
                          <Button 
                            icon={job.isSaved ? <StarFilled /> : <StarOutlined />}

...
import { Row, Col, Card, Typography, Button, Divider, message, Space, Spin, Modal, Input, Tooltip, Select, Slider, Upload, ColorPicker, Progress } from 'antd';
...
const CV_TEMPLATES = [
  { 
    ...
    name: 'Modern', 
    color: '#3366FF',
    description: 'Mẫu hiện đại với thiết kế sạch sẽ, phù hợp cho hầu hết ngành nghề'
  },
  {
    id: 'professional',
    name: 'Professional',
    color: '#0078D7',
    description: 'Mẫu chuyên nghiệp phù hợp với môi trường doanh nghiệp và lĩnh vực tài chính, luật'
  },
  {
    id: 'creative',
    name: 'Creative',
  ...
  },
  {
    ...
    name: 'Elegant',
    color: '#107C41',
    description: 'Mẫu sang trọng với bố cục thanh lịch, phù hợp cho những người muốn tạo ấn tượng cao cấp'
  }
];
...
const AVAILABLE_SECTIONS = [
  { id: 'workExperience', name: 'Kinh nghiệm làm việc', description: 'Mô tả các kinh nghiệm làm việc của bạn càng chi tiết càng tốt.' },
  { id: 'education', name: 'Học vấn', description: 'Mô tả toàn bộ quá trình học vấn của bạn, cùng như các bằng cấp bạn đã đạt được.' },
  { id: 'languages', name: 'Ngoại ngữ', description: 'Liệt kê các chứng chỉ ngoại ngữ mà bạn đã đạt được.' },
  { id: 'references', name: 'Người tham khảo', description: 'Thông tin người tham khảo giúp tăng độ tin cậy cho hồ sơ của bạn.' },
  { id: 'activities', name: 'Hoạt động', description: 'Liệt kê những hoạt động bạn đã tham gia trong quá trình học hoặc làm việc.' },
  { id: 'skills', name: 'Kỹ năng', description: 'Danh sách các kỹ năng chuyên môn và mức độ thành thạo.' },
  { id: 'projects', name: 'Dự án', description: 'Mô tả các dự án bạn đã tham gia hoặc thực hiện.' },
  { id: 'certificates', name: 'Chứng chỉ', description: 'Liệt kê các chứng chỉ chuyên môn bạn đã đạt được.' },
];
    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="error-boundary-fallback" style={{ 
          ...
          <p>The application encountered an error while updating the template. Please try again.</p>
...
const CVBuilder = ({ onFinish, existingCvData = null }) => {
  ...
  const [careerObjective, setCareerObjective] = useState('Nhập mục tiêu nghề nghiệp của bạn tại đây...');
  ...
  const [profilePhotoUrl, setProfilePhotoUrl] = useState('https://placehold.co/200x200');
  ...
  const addSection = (sectionType) => {
    const sectionTemplate = AVAILABLE_SECTIONS.find(s => s.id === sectionType);
  ...
  const handleSave = async () => {
    try {
      ...
      const pdfUrl = await uploadToCloudinary(
        new File([pdfBlob], `${fullName.replace(/\s+/g, '_')}_CV.pdf`, { type: 'application/pdf' }),
        "student"
      );
  ...
  const handleProfilePhotoChange = async info => {
    ...
    try {
        ...
        if (file instanceof File) {
          ...
          message.loading({ content: 'Đang tải ảnh lên...', key: messageKey, duration: 0 });
          console.log("Uploading photo to Cloudinary...");
          const uploadedUrl = await uploadToCloudinary(file, "student", (progress) => {
  ...
  const addSkill = () => {
    ...
    setSkills([...skills, { id: newId, name: 'Kỹ năng mới', level: 'Beginner' }]);
  };
  ...
  const renderEditableHeader = () => {
    switch (selectedTemplate.id) {
          ...
          <div className="cv-header" style={{ 
            ...
            <div className="profile-photo-container">
              <Upload
                ...
                style={{ width: '100%', height: '100%', display: 'block', cursor: 'pointer', position: 'relative', zIndex: 20 }}
              >
                {profilePhotoUrl ? (
                  <div className="profile-photo" style={{ border: 'none' }}>
                    <img src={profilePhotoUrl} alt="Profile" style={{ maxWidth: '100%', maxHeight: '100%' }} />
                  </div>
                ) : uploadButton}
              </Upload>
            </div>
                ...
                >
                  {profilePhotoUrl ? (
                    <div className="profile-photo" style={{ 
                      ...
                      <img src={profilePhotoUrl} alt="Profile" style={{ width: '100%' }} />
                    </div>
                  ) : uploadButton}
                </Upload>
              </div>
            ...
            <div className="contact-details" style={{ 
              ...
              <div className="contact-item">
                ...
                <span 
                  contentEditable 
                  suppressContentEditableWarning
                  onBlur={e => setContactInfo({...contactInfo, address: e.target.innerText})}
                >
                  {contactInfo.address}
                </span>
              </div>
      ...
      default: // modern
        return (
          <div className="cv-header" style={{ backgroundColor: `${selectedColor}10` }}>
            <div className="profile-photo-container">
              <Upload
                name="avatar"
                listType="picture-card"
              ...
              >
                {profilePhotoUrl ? (
                  <div className="profile-photo" style={{ border: `3px solid ${selectedColor}` }}>
            ...
            <div className="header-content">
              ...
              <div className="contact-details">
                <div className="contact-item">
                  <span className="contact-icon" style={{ color: selectedColor }}>📱</span>
                  <span 
                ...
                <div className="contact-item">
                  <span className="contact-icon" style={{ color: selectedColor }}>✉️</span>
                  <span 
                    className="contact-text" 
                    contentEditable 
                    suppressContentEditableWarning
      ...
      setTimeout(() => {
        try {
          ...
          if (cvA4Page) {
            ...
            const classesToRemove = Array.from(cvA4Page.classList)
              .filter(cls => cls.startsWith('template-'));
  ...
  const uploadButton = (
    <div className="upload-button-container" style={{ cursor: 'pointer', width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
      {uploadingPhoto ? (
        <div className="upload-progress-container">
          ...
          />
          <div style={{ fontSize: '12px', marginTop: 5 }}>Đang tải... {uploadPhotoProgress}%</div>
        </div>
      ) : (
        <>
          ...
          {previewMode ? (
            ...
            <div className="cv-main-content">
              ...
              <div className="cv-sidebar">
                <div className="sidebar-section">
                  ...
                  <Modal
                    ...
                    width={700}
                    footer={[
                      <Button key="back" onClick={() => setShowTemplateSelector(false)}>
                        Đóng
                      </Button>,
                      <Button 
                        key="submit" 
                  ...
                  >
                    <div style={{ padding: '10px 0'}}>
                      <Text>Mẫu hiện tại: <Text strong>{selectedTemplate.name}</Text></Text>
                      <Divider />
                      <CVTemplateSelector
                  ...
                  <div className="color-controls">
                    ...
                    <div className="color-options">
                      ...
                      <div className="color-preset add-color" onClick={() => setShowColorPicker(!showColorPicker)}>
                        <PlusOutlined />
                      </div>
                    </div>
                    ...
                    <Modal
                      ...
                      footer={[
                        <Button key="back" onClick={() => setShowColorPicker(false)}>
                          Hủy
                        </Button>,
                        <Button 
                          key="submit" 
                      ...
                      <div style={{ textAlign: 'center', marginBottom: '20px' }}>
                        <ColorPicker
                          ...
                          presets={[
                            {
                              label: 'Màu đề xuất',
                              colors: CV_COLOR_PRESETS.map(preset => preset.color),
                            },
                            {
                              label: 'Trung tính',
                  ...
                  <div className="font-controls">
                    ...
                    <div className="control-group">
                      ...
                      <Select 
                        ...
                        onChange={(value) => {
                          if (i18n) {
                            const changeLang = value === 'vi' ? 'vi-VN' : 'en-US';
                      ...
                      <div key={section.id} className="section-item">
                        ...
                        >
                          <div className="section-btn-content">
                            <div className="section-btn-title">{section.name}</div>
              ...
              <div className="cv-preview-container">
                <div className="cv-a4-page" style={{ 
                  ...
                  <div className="cv-section">
                    <div className="section-title" style={{ borderBottomColor: selectedColor }}>
                    ...
                    <div className="section-content personal-info">
                      <div className="personal-info-item">
                        ...
                        <div 
                          ...
                          contentEditable 
                          suppressContentEditableWarning
                          onBlur={e => setPersonalInfo({...personalInfo, birthDate: e.target.innerText})}
                        >
                      ...
                      <div className="personal-info-item">
                        ...
                        <div 
                          ...
                          contentEditable 
                          suppressContentEditableWarning
                          onBlur={e => setPersonalInfo({...personalInfo, nationality: e.target.innerText})}
                        >
                      ...
                      <div className="personal-info-item">
                        ...
                        <div 
                          ...
                          contentEditable 
                          suppressContentEditableWarning
                          onBlur={e => setPersonalInfo({...personalInfo, maritalStatus: e.target.innerText})}
                        >
                      ...
                      <div className="personal-info-item">
                        ...
                        <div 
                          ...
                          contentEditable 
                          suppressContentEditableWarning
                          onBlur={e => setPersonalInfo({...personalInfo, gender: e.target.innerText})}
                        >
                          {personalInfo.gender}
                        </div>
                      </div>
                    ...
                    <div className="section-content timeline-section">
                      {workExperiences.map((exp, index) => (
                        <div key={exp.id} className="timeline-item">
                          <div className="timeline-point" style={{ borderColor: selectedColor }}></div>
                          <div className="timeline-date">
                            <span
                              contentEditable
                              suppressContentEditableWarning
                              onBlur={e => updateWorkExperience(exp.id, 'startDate', e.target.innerText)}
                            ...
                            <span
                              contentEditable
                              suppressContentEditableWarning
                              onBlur={e => updateWorkExperience(exp.id, 'endDate', e.target.innerText)}
                              className="date-field"
                            >
                              {exp.endDate}
                            </span>
                          ...
                          <div className="timeline-content">
                            <div className="timeline-item-header">
                              <div 
                                contentEditable
                                suppressContentEditableWarning
                                onBlur={e => updateWorkExperience(exp.id, 'companyName', e.target.innerText)}
                            ...
                            <div 
                              contentEditable
                              suppressContentEditableWarning
                              onBlur={e => updateWorkExperience(exp.id, 'jobTitle', e.target.innerText)}
                              className="job-title"
                            >
                              {exp.jobTitle}
                            </div>
                            <div 
                              contentEditable
                              suppressContentEditableWarning
                              onBlur={e => updateWorkExperience(exp.id, 'description', e.target.innerText)}
                        ...
                        <div key={cert.id} className="timeline-item">
                          ...
                          <div className="timeline-date">
                            <span
                              contentEditable
                              suppressContentEditableWarning
                              onBlur={e => updateCertificate(cert.id, 'date', e.target.innerText)}
                              className="date-field"
                            >
                              {cert.date}
                            </span>
                          ...
                          <div className="timeline-content">
                            <div className="timeline-item-header">
                              <div 
                                contentEditable
                                suppressContentEditableWarning
                                onBlur={e => updateCertificate(cert.id, 'organization', e.target.innerText)}
                            ...
                            <div 
                              contentEditable
                              suppressContentEditableWarning
                              onBlur={e => updateCertificate(cert.id, 'name', e.target.innerText)}
                            ...
                            <div 
                              contentEditable
                              suppressContentEditableWarning
                              onBlur={e => updateCertificate(cert.id, 'description', e.target.innerText)}
                              className="description"
                            >
                              {cert.description}
                            </div>
                      ...
                      {skills.map(skill => (
                        <div key={skill.id} className="skill-item">
                          <div 
                            ...
                            contentEditable
                            suppressContentEditableWarning
                            onBlur={e => updateSkill(skill.id, 'name', e.target.innerText)}
                          >
                            {skill.name}
                          </div>
                  ...
                  {sections.map((section, index) => (
                    <div key={section.id} className="cv-section draggable-section">
                      ...
                      <div className="section-content" contentEditable suppressContentEditableWarning>
                    ...
                    onClick={() => {
                      ...
                      setSections(prevSections => [
                        ...prevSections,
                        {
                          ...
                          title: 'MỤC MỚI',
                          position: prevSections.length,
                          content: { text: 'Nhập nội dung cho mục mới tại đây...' }
                        }
                      ]);

...
import { Tree, Input, Button, Modal, Form, Select, message } from "antd";
import {
  ClockCircleOutlined,
  EditOutlined,
  DeleteOutlined,
...
const TimeConfigTree = ({
  ...
  const buildTreeData = () => {
            ...
            <div className="schedule-info">
              ...
              <div className="schedule-details">
                <div className="schedule-name">
                  {schedule.name || getCronDescription(schedule.cronExpression)}
                </div>
    ...
    return Object.values(frequencyGroups).filter(
  ...
  const handleModalOk = async () => {
    try {
      ...
      form.resetFields();
      message.success(
        editingSchedule ? "Cập nhật thành công!" : "Thêm cấu hình thành công!"
      );
    } catch (error) {
  ...
  const availableTemplates = selectedFrequency
    ? cronTemplates[selectedFrequency] || {}
    : {};

        ...
        <>
            <BoxContainer className="shadow-md">
                <div className="title1">
                    {t('employer.company.certificate.title')}
                </div>
            </BoxContainer>
            <BoxContainer className="shadow-md">
                <Flex gap="1rem" align="center" >
                    <Form className="w-full md:w-7/12" onChange={onChange} form={form} onFinish={onFinish} layout="vertical" size="large" initialValues={{ businessCertificate }} >
                        ...
                        <Form.Item>
                            <Flex align='center' justify='end'>
                                <Button type='primary' htmlType='submit' disabled={loading || !change}>
                                    <IconLoading loading={loading} setLoading={setLoading} /> {t('common.save')}
                                </Button>
                            </Flex>
                        </Form.Item>
                    </Form>
                    <div className="hidden md:block w-5/12">
                        <Flex align="center" justify="center" vertical>
                            <div className="mb-1" style={{ fontSize: "1rem" }}>{t('employer.company.certificate.previewTitle')}</div>
                            <Image alt={t('employer.company.certificate.previewAlt')} src="https://res.cloudinary.com/utejobhub/image/upload/v1727667740/company/tma_technology_group_business_certificate.jpg" width="60%" />
                        </Flex>
                    </div>
                </Flex>
            </BoxContainer>

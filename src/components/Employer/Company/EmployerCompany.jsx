import { Button, Col, Flex, Form, Input, Row, Select, message, Card, Typography, Tooltip, Tabs } from 'antd';
...
const EmployerCompany = () => {
    ...
    return (
        <>
            <BoxContainer className='shadow-md company-header'>
                        ...
                        >
                            ...
                            >
                                <Row gutter={[24, 16]}>
                                    ...
                                    <Col xs={24} md={14}>
                                        <Form.Item name="companyEmail" label={t('employer.company.email')}>
                                            <Input allowClear />
                                        </Form.Item>
                                    </Col>
                                            ...
                                            <Form.List name="benefitArray">
                                                {(fields, { add, remove }) => (
                                                    <div className="benefits-list">
                                                        {fields.map((field) => (
                                                            <Flex key={field.name} gap="middle" className="benefit-item">
                                                                <Form.Item 
                                                                    name={[field.name, 'benefitId']} 
                                                                    className="benefit-type"
                                                                >
                                                                    <Select placeholder={t('employer.company.benefitType')}>
                                                        ...
                                                        {fields.length < 3 && (
                                                            <Button 
                                                                ...
                                                                onClick={() => add()} 
                                                                icon={<PlusCircleFilled style={{ color: "#4096FF" }} />} 
                                                                type='text'
                                                            >

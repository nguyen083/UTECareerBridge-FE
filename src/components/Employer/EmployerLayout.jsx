...
import { Layout, Menu, Avatar, Flex, Badge, Button, Tooltip, message, Input, Dropdown, Space, Typography } from 'antd';
                        ...
                        <div className="header-left">
                            ...
                            <div className="company-info">
                                {!collapsed && companyName && (
                                    <Text strong className="company-name">{companyName}</Text>
                                )}
                            </div>
                        </div>
                                ...
                                <div className="user-profile">
                                    ...
                                    {!collapsed && (
                                        <Space direction="vertical" size={0} className="user-info">
                                            <Text strong className="username">{`${employerInfo?.firstName || ''} ${employerInfo?.lastName || ''}`}</Text>
                                            <Text type="secondary" className="user-role">{t('role.EMPLOYER')}</Text>
                                        </Space>
                                    )}
                                </div>
                            </Dropdown>

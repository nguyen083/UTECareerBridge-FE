...
import { Button, Table, Tag, Tooltip, message, Space, Divider } from "antd";
...
const ListOrder = () => {
  ...
  const columns = [
...

    {
      ...
      render: (text) =>
        text === "PENDING" ? (
          <Tag className="text-sm font-normal w-fit" color="default">
            {t("employer.orders.pending")}
          </Tag>
        ) : (
          <Tag className="text-sm font-normal w-fit" color="green">

...
import { Row, Col, Card, Button, List, Space, Image, Typography, Flex, Carousel, Divider, Descriptions } from 'antd';
...
import JobCardSmall from '../Generate/JobCardSmall';
            ...
            <Row gutter={[8, 8]}>
                    ...
                    <Flex vertical gap={8}>
                        <BoxContainer padding='1rem'>
                            <Flex vertical gap={"1.25rem"}>
                                ...
                                {job?.benefitDetails && <Flex vertical gap={"1rem"}>
                                    <div className='title2'>
                ...
                <Col xs={24} md={8} lg={6}>
                    <Row gutter={[0, 8]}>
                        ...
                        <Card title={<div className='title2 p-3 text-center'>Việc làm tương tự</div>}

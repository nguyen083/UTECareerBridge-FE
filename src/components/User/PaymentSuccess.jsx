import { Button, Result, Typography, Card, Flex, Divider, Row, Col, Avatar } from "antd";
import { useNavigate, useLocation } from "react-router-dom";
import Pride from "react-canvas-confetti/dist/presets/pride";
import { useEffect, useState } from "react";
import { CheckCircleFilled, ShoppingOutlined, HomeOutlined, FileTextOutlined } from "@ant-design/icons";
    ...
    <div className="payment-success-container">
      ...
      <Card className="success-card">
        <Result
          ...
          title={<Title level={2} className="success-title">Thanh toán thành công!</Title>}
          subTitle={
            <Paragraph className="success-subtitle">
              Cảm ơn bạn đã sử dụng dịch vụ của UTECareerBridge. Đơn hàng của bạn đã được xác nhận và thanh toán thành công.
            </Paragraph>
          }
        />
                ...
                <div className="info-block">
                  ...
                  <div className="info-item">
                    ...
                    <Flex align="center" gap={8}>
                      <Avatar size="small" src="https://res.cloudinary.com/utejobhub/image/upload/v1733687883/vnpay_vgngax.png" />
                      <Text>VNPAY</Text>
                    </Flex>
                  </div>
                  <div className="info-item">
                  ...
                  <div className="info-item total-row">
                    <Text strong className="total-label">Tổng tiền:</Text>
                    <Text className="total-value">{formatCurrency(orderData.total)}</Text>
                  </div>
                </div>
              </Col>
            </Row>
                  ...
                  <Flex align="center" justify="space-between">
                    <Flex align="center" gap={12}>
                      ...
                      <div className="package-info">
                        <Text strong className="package-name">{item.packageResponse.packageName}</Text>
                        <Text type="secondary">{item.packageResponse.description}</Text>
                      </div>
                    </Flex>

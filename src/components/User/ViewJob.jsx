              ...
              <BoxContainer className="shadow" padding="1rem">
                <Flex vertical gap={"1.25rem"}>
                  <BoxContainer background="#F8F9FA">
                    <div className="text-lg font-[550] text-[#333] leading-4 text-[1.35rem] mb-5">
                      {job.jobTitle}{" "}
                    </div>
                    <div className="mb-3 salary">
                      Lương: {job?.jobMinSalary?.toLocaleString("vi-VN")} -{" "}
                    ...
                    <Flex className="mb-3">
                      <Text>
                        <ClockCircleOutlined className="icon-small" /> Hết hạn
                        ngày: {job.jobDeadline}{" "}
                      </Text>
                  ...
                  {job?.benefitDetails?.length !== 0 && (
                    <Flex vertical gap={"1rem"}>
                      <div className="title2">Các phúc lợi dành cho bạn</div>
            ...
            <Row gutter={[0, 8]}>
                ...
                <Flex align="center" vertical style={{ marginTop: -50 }}>
                  ...
                  >
                    <Text
                      ...
                      strong
                      className="text-base hover-effect"
                    >
                      {company.companyName}
                    </Text>
              ...
              {carouselItems.length > 0 && (
                <Card
                  className="shadow"
                  title={
                    <div className="p-3 title2">Công ty cùng lĩnh vực</div>
                  }
              ...
              {jobSameCompany && jobSameCompany.length > 0 && (
                <Card
                  className="shadow"
                  title={
                    <div className="p-3 text-center title2">

...
export const ModalApply = ({ show, setShow, company, job }) => {
  ...
  return (
    <Modal
      title={
        <>
          <Title level={4}>{t("job.apply.title")}</Title>{" "}
      ...
      <Row gutter={[8, 8]}>
            ...
            <Flex vertical gap={8}>
              <BoxContainer className="shadow" padding="0.5rem">
                <Flex gap={3} align="center">
                  ...
                  />
                  <Text className="text-base" type="secondary">
                    <LineEllipsis line={2}>{company.companyName}</LineEllipsis>
                  </Text>
                </Flex>
              </BoxContainer>
              <BoxContainer className="shadow" padding="0.5rem">
                <Flex vertical>
                  ...
                  <Flex align="center" gap={4}>
                    ...
                    />{" "}
                    <Text className="text-sm">{job?.jobLocation}</Text>
                  </Flex>
                </Flex>
              </BoxContainer>
            </Flex>
        ...
        <Col span={15}>
          <Card
            className="shadow"
            size="default"
            title={t("job.apply.selectApplication")}
          >
            <Flex vertical>

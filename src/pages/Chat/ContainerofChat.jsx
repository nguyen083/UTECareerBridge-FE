  ...
  return (
    <div className="flex justify-end w-full">
      <Flex gap={8} align="center" className="max-w-[85%]">
        ...
        <div className="px-4 py-2 bg-blue-500 rounded-t-3xl rounded-s-3xl ">
  ...
  return (
    <div className="flex justify-start w-full">
      <Flex gap={8} align="center" className="w-3/4">
        <div className="px-4 py-2 bg-gray-200 rounded-t-3xl rounded-e-3xl chat-message-content">
          <div
            className="text-base"
...
export { SenderChat, ReceiverChat };

  ...
  return (
    <>
      <Row className="min-h-screen">
        <Col span={6} className="min-h-full p-4 ">
          <Space size={"small"} className="w-full pb-5 " direction="vertical">
            <Flex
              ...
              align="center"
              className="w-full pb-4 border-b"
            >
              <Image
        ...
        <Col
          span={12}
          className="flex flex-col max-h-screen border border-x-gray-200 bg-gray-50 bg-opacity-55"
        >
          <Space
            direction="vertical"
          ...
          {recipientId ? (
            <>
              <CardCompany
                className="rounded-t-none shadow-md"
                company={companyInfor}
              />
              <div
                className="flex flex-col flex-1 w-full h-auto gap-4 p-2 overflow-y-auto "
                ref={divRef}
              >
                {messages.length === 0 && (
                  <Empty
                    className="mt-36"
                    image={<Avatar src={companyInfor.companyLogo} size={100} />}
                    description={
                      <Text className="text-lg font-bold text-text-color">
              ...
              <Flex
                className="bg-white p-2 w-full h-auto mb-4 border-t shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]"
                gap={16}
                justify="center"
                align="flex-end"
              >
        ...
        <Col span={6} className="min-h-full">
          <Space
            size={"large"}
            className="w-full py-5 ps-3"
            direction="vertical"
          >
            <Text className="h-auto text-sm font-bold uppercase text-text-color">
              {t("job_application_submitted")}
            </Text>
            <ListJob />
          </Space>
        </Col>
